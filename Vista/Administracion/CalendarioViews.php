...
public static function generarcalendarioFestivo(){
        ...
        <script>
            function generar_calendario(mes,anio)
            {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo parent::getUrlRaiz()?>/Controlador/Administracion/ControladorCalendario.php",
                    cache: false,
                    data: { mes:mes,anio:anio,accion:"generar_calendario" }
                }).done(function( respuesta )
                {
            ...
            $(document).ready(function()
            {
                ...
                $(document).on("click",'a.add',function(e)
                {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo parent::getUrlRaiz()?>/Vista/Administracion/GeneradorFormsViews.php",
                        cache: false,
                    ...
                    $('#mask').fadeIn(700)
                        .html(
                            ...
                            "<h2>Festivo, día "+formatDate(fecha)+"</h2>" +
                            "</div>" +
                            "<div class='window row' rel='"+fecha+"'>"+
                            "<div id='respuesta_form' class='col-xs-12 col-md-8 col-md-offset-2'></div>" +
                            "<div class='col-xs-12 col-md-8 col-md-offset-1'>"+
                            "<form class='formeventos form-horizontal' id='festivosForm' method='post' action='<?php echo parent::getUrlRaiz();?>/Controlador/Administracion/Router.php'>" +
                ...
                $(document).on("click",'a.evento',function(e)
                {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo parent::getUrlRaiz()?>/Controlador/Admistracion/ControladorCalendario.php",
                        cache: false,
                        data: { fecha:fecha,accion:"listar_evento" }
                    }).done(function( respuesta )
                    {
